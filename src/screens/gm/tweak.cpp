...
: GuiTweakPage(owner)
{
    ...
    {
        (new GuiLabel(left_col, "", LanguageManager::get(getMissileWeaponName(EMissileWeapons(n))) + ":", 20))->setSize(GuiElement::GuiSizeMax, 30);
    ...
    for(int n=0; n<MW_Count; n++)
    {
        (new GuiLabel(right_col, "", LanguageManager::get(getMissileWeaponName(EMissileWeapons(n))) + ":", 20))->setSize(GuiElement::GuiSizeMax, 30);
...
: GuiTweakPage(owner)
{
    ...
    for(int n=0; n<MW_Count; n++)
    {
        allowed_use[n] = new GuiToggleButton(right_col, "", LanguageManager::get(getMissileWeaponName(EMissileWeapons(n))), [this, n](bool value) {
            if (value)
...
: GuiTweakPage(owner)
{
    ...
    for(int n=0; n<SYS_COUNT; n++)
    {
        ...
        (new GuiLabel(left_col, "", LanguageManager::get(getSystemName(system)) + LanguageManager::get(" health"), 20))->setSize(GuiElement::GuiSizeMax, 30);
        ...
        (new GuiLabel(right_col, "", LanguageManager::get(getSystemName(system)) + LanguageManager::get(" heat"), 20))->setSize(GuiElement::GuiSizeMax, 30);
