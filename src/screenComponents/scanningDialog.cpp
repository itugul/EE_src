...
void GuiScanningDialog::setupParameters()
{
    ...
    {
    default:
    case 0: label += LanguageManager::get("Electric signature"); break;
    case 2: label += LanguageManager::get("Gravity well signature"); break;
    case 1: label += LanguageManager::get("Biomass frequency"); break;
    case 3: label += LanguageManager::get("Radiation halftime"); break;
    case 4: label += LanguageManager::get("Radio profile"); break;
    case 5: label += LanguageManager::get("Ionic phase shift"); break;
    case 6: label += LanguageManager::get("Infra-red color shift"); break;
    case 7: label += LanguageManager::get("Doppler stability"); break;
    case 8: label += LanguageManager::get("Raspberry jam prevention"); break;
    case 9: label += LanguageManager::get("Infinity impropability"); break;
    case 10: label += LanguageManager::get("Zerospace audio frequency"); break;
    }
