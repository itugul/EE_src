...
{
    // Translation of text and conversion to multibit format.
    text = LanguageManager::get(text);
    sf::String converted = sf::String::fromUtf8(text.begin(), text.end());
    sf::Text textElement(converted, *font, font_size);
